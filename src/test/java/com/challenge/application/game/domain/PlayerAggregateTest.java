...
public class PlayerAggregateTest {
    ...
    public void getRootPlayer() {
        ...
        playerAggregate = new PlayerAggregate(Arrays.asList(player1, new Player("2", "p2")), 0);
    ...
    public void getNext() {
        ...
        playerAggregate = new PlayerAggregate(Arrays.asList(new Player("1", "p1"), player2), 0);
    ...
    public void getNextCyclic() {
        Player player1 = new Player("1", "p1");
        playerAggregate = new PlayerAggregate(Arrays.asList(player1, new Player("1", "p1")), 0);
    ...
    public void isNotValidWithLowerNumberOfPlayers() {
        playerAggregate = new PlayerAggregate(Arrays.asList(new Player("1", "p1")), 0);
    ...
    public void isNotValidWithHigherNumberOfPlayers() {
        playerAggregate = new PlayerAggregate(Arrays.asList(new Player("1", "p1"), new Player("1", "p2"), new Player("1", "p3")), 0);
